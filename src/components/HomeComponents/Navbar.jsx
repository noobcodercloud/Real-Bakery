          ...
          <div className="max-w-5xl mx-auto px-4 py-3 w-full">
            <div className="flex flex-col sm:flex-row items-center justify-between w-full">
              ...
              <div className="flex space-x-6 text-gray-900 font-medium justify-evenly w-full">
                <NavLink to="/" className={({ isActive }) => `${isActive ? "drop-shadow-[0_0_8px_rgba(245,158,11,0.8)] text-amber-500" : ""} transition-all duration-300 hover:text-amber-500 hover:drop-shadow-[0_0_8px_rgba(245,158,11,0.8)]`}>Online Menu</NavLink>
                <NavLink to="/About" className={({ isActive }) => `${isActive ? "drop-shadow-[0_0_8px_rgba(245,158,11,0.8)] text-amber-500" : ""} transition-all duration-300 hover:text-amber-500 hover:drop-shadow-[0_0_8px_rgba(245,158,11,0.8)]`}>About</NavLink>
                {/* <NavLink to="/" className={`transition-all duration-300 hover:text-amber-500 hover:drop-shadow-[0_0_8px_rgba(245,158,11,0.8)]`}>Restaurants</NavLink> */}
                <NavLink to="/Contact" className={({ isActive }) => `${isActive ? "drop-shadow-[0_0_8px_rgba(245,158,11,0.8)] text-amber-500" : ""} transition-all duration-300 hover:text-amber-500 hover:drop-shadow-[0_0_8px_rgba(245,158,11,0.8)]`}>Contact</NavLink>
                <NavLink to="/Login"
                  className={({ isActive }) => `${isActive ? "drop-shadow-[0_0_8px_rgba(245,158,11,0.8)] text-amber-500" : ""} transition-all duration-300 hover:text-amber-500 hover:drop-shadow-[0_0_8px_rgba(245,158,11,0.8)]`}>Login</NavLink>
              </div>
            </div>
          </div>
        </nav>
          ...
          <div className="max-w-5xl p-3 transition-all">
            <div className="flex flex-col items-center h-screen py-6">
              ...
              <div className="flex text-gray-900 font-medium justify-evenly items-center w-full flex-col h-[50%] my-10 gap-5">
                <NavLink to="/"
                  className={ ({ isActive }) => `${isActive ? "drop-shadow-[0_0_8px_rgba(245,158,11,0.8)] text-amber-500" : ""} hover:bg-amber-600/20 p-4 rounded-2xl w-[70%] text-center transition-all duration-500 border border-transparent hover:border hover:border-amber-800`}
                  onClick={() => setOpen(!Open)}
                >Online Menu</NavLink>
                <NavLink to="/About"
                  className={ ({ isActive }) => `${isActive ? "drop-shadow-[0_0_8px_rgba(245,158,11,0.8)] text-amber-500" : ""} hover:bg-amber-600/20 p-4 rounded-2xl w-[70%] text-center transition-all duration-500 border border-transparent hover:border hover:border-amber-800`}
